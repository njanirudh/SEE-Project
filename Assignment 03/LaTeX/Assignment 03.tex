...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=]{Extra/pipeline.png}
% 	\caption{Computer vision algorithm pipeline}
% \end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Forward-X.jpg}
	\caption{Fit for X Coordinate - Forward}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth ]{Graphs/Forward-Y.jpg}
	\caption{Fit for Y Coordinate - Forward}
\end{figure}	

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth ]{Graphs/Forward-Angle.jpg}
	\caption{Fit for angle - Forward}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Left-X.jpg}
	\caption{Fit for X Coordinate - Left}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Left-Y.jpg}
	\caption{Fit for Y Coordinate - Left}
\end{figure}	

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Left-Angle.jpg}
	\caption{Fit for angle - Left}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Right-X.jpg}
	\caption{Fit for X Coordinate - Right}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Right-Y.jpg}
	\caption{Fit for Y Coordinate - Right}
\end{figure}	

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Right-Angle.jpg}
	\caption{Fit for angle - Right}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Start-X.jpg}
	\caption{Fit for X Coordinate - Start Position}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Start-Y.jpg}
	\caption{Fit for Y Coordinate - Start Position}
\end{figure}	

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth ]{Graphs/Start-Angle.jpg}
